...
export default function BuildingBtn({ name, usage, date_created }) {
    ...
    const params = language === "en" ? english_text.BuildingBtn : greek_text.BuildingBtn                                  ;
    ...
    return (
        <>
            ...
            <div className="info w-[180px]">
                <label className="building-name opacity-80 font-bold text-primary">{name}</label>
                <div className="building-details flex flex-col">
                    <span className="opacity-80 font-medium text-primary text-[13px]">{params.usage}: {usage}</span>
