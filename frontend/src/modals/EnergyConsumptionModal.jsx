...
function EnergyConsumptionModalForm({ 
  ...
  console.log("EnergyConsumptionModalForm: open is true, rendering modal content.");
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              className={`input-field ${errors.energy_source ? "error-input" : ""}`}
              required
            >
            ...
            {errors.energy_source && (
              <div className="text-red-500 text-xs mt-1">{errors.energy_source}</div>
            )}
          </div>
          ...
          <InputEntryModal
            entry={params.quantity || "Quantity"}
            id="quantity"
            type="number"
            value={formData.quantity}
            onChange={handleChange}
            example={params.quantity_example || "e.g., 1000"}
...
export default function EnergyConsumptionModal({ 
  ...
  console.log("EnergyConsumptionModal (default export): Rendering, open prop is:", open);
