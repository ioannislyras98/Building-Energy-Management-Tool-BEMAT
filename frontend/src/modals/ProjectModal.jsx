...
function ProjectModalForm({ isOpen, onClose, onProjectCreated, onProjectUpdated, project, isEditMode, params }) {
        ...
        <form id="project-form" onSubmit={handleSubmit}>
          <div>
            ...
            <InputEntry
              ...
              onChange={(e) => setFormData({ ...formData, cost_per_kwh_fuel: e.target.value })}
            ...
            <InputEntry
              ...
              onChange={(e) => setFormData({ ...formData, cost_per_kwh_electricity: e.target.value })}
...
export default function ProjectModal({ isOpen, onClose, onProjectCreated, onProjectUpdated, project, isEditMode }) {
  const { language } = useLanguage();
  const params = language === "en" ? english_text.ProjectModal : greek_text.ProjectModal;
