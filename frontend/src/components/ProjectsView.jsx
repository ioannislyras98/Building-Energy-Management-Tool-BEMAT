...
import ProjectBtn from "../pages/ProjectBtn";
    ...
    <div className="my-projects">
      ...
      <div className="projects-grid">
        ...
        {projects.length > 0 ? (
          ...
          <div className="no-projects" style={{ display: projects.length === 0 ? 'block' : 'none' }}>
            <p>{params.noProjects || "No projects found. Click the + card to create a new project."}</p>
          </div>
        )}
      </div>
    </div>
