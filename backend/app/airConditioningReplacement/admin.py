...
class AirConditioningAnalysisAdmin(admin.ModelAdmin):
    list_display = ('building', 'energy_savings_kwh', 'annual_cost_savings', 'payback_period', 'created_at')
    list_filter = ('building', 'created_at')
    search_fields = ('building__name',)
    ordering = ('-created_at',)
    readonly_fields = ('id', 'total_old_consumption', 'total_new_consumption', 'energy_savings_kwh',
                       'total_investment_cost', 'annual_cost_savings', 'payback_period',
    ...
    fieldsets = (
        ...
        ('Οικονομικά Στοιχεία', {
            'fields': ('energy_cost_kwh', 'maintenance_cost_annual', 'lifespan_years', 'discount_rate')
        }),
        ('Αποτελέσματα Ανάλυσης', {
            'fields': ('total_old_consumption', 'total_new_consumption', 'energy_savings_kwh',
                      'total_investment_cost', 'annual_cost_savings', 'payback_period',
