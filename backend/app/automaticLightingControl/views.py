...
from .serializer import AutomaticLightingControlSerializer
...
def get_automatic_lighting_control_by_building(request, building_id):
    ...
    try:
        ...
        # Αναζήτηση εγγραφής αυτόματου ελέγχου φωτισμού
...
@api_view(['POST'])
@permission_classes([IsAuthenticated])
def automatic_lighting_control_create(request):
    """
    Δημιουργία ή ενημέρωση στοιχείων αυτόματου ελέγχου φωτισμού
    """
    try:
        ...
        try:
            ...
            serializer = AutomaticLightingControlSerializer(
            ...
            serializer = AutomaticLightingControlSerializer(data=request.data)
        
        if serializer.is_valid():
            automatic_lighting_control = serializer.save()
            return Response(
                AutomaticLightingControlSerializer(automatic_lighting_control).data,
