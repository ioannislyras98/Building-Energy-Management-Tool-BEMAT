# Generated by Django 5.1.6 on 2025-06-28 18:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_name', models.CharField(help_text='Αυτόματη συμπλήρωση από το επιλεγμένο υλικό', max_length=100, verbose_name='Όνομα Υλικού')),
                ('material_thermal_conductivity', models.FloatField(help_text='Αυτόματη συμπλήρωση από το επιλεγμένο υλικό', verbose_name='Θερμική Αγωγιμότητα (W/mK)')),
                ('surface_type_display', models.CharField(help_text='Περιγραφή του τύπου επιφάνειας', max_length=100, verbose_name='Επιφάνεια (Περιγραφή)')),
